...
public class NodeListFragment extends ListFragment {
	...
	private MainCustomArrayAdapter adapterMain;
	public MainCustomArrayAdapter getAdapterMain() { return adapterMain; }
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapterMain = new MainCustomArrayAdapter(getActivity(), 
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(Helper.ITEMS.get(position).getId());
	}
